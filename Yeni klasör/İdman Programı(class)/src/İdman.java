...
public class İdman {
    ...
    public void burpeeYap(int sayi){
        ...
        if (burpee_sayisi - sayi < 0){
            System.out.println("Tebrikler Kendinizi astiniz");
        }
        else{
            burpee_sayisi -= sayi;
            System.out.println("Kalan yapmaniz gereken burpee adeti = " + burpee_sayisi);
        } 
    }
    public void pushupYap(int sayi){
        ...
        if (pushup_sayisi - sayi < 0){
            ...
            pushup_sayisi -= sayi;
            System.out.println("Kalan yapmaniz gereken pushup adeti = " + pushup_sayisi);
        } 
    }
    public void situpYap(int sayi){
        ...
        if (situp_sayisi - sayi < 0){
            ...
            situp_sayisi -= sayi;
            System.out.println("Kalan yapmaniz gereken situp adeti = " + situp_sayisi);
        } 
    }
    public void squatYap(int sayi){
        ...
        if (squat_sayisi - sayi < 0){
            ...
            squat_sayisi -= sayi;
            System.out.println("Kalan yapmaniz gereken squat adeti = " + squat_sayisi);
        } 
    }
